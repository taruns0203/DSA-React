/* ================================================================
   🎨  Theme System
   CSS-variable–driven, light/dark support.
   Usage: spread THEME[mode] as inline style on root wrapper,
   then reference tokens via v("--c-*") helper.
   ================================================================ */
...
/** Shorthand to reference a CSS variable in inline styles */
